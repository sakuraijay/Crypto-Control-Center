...
beforeEach(async () => {
  ...
  const { reconcileOnRestart, __setStopExecutionAvailabilityForTests, __setProtectionReconStateForTests } = await import('../workers/liveTestExecutor');
...
function openParams() {
  return {
    ...
    sizingContext: testSizingContext(),
  };
}
