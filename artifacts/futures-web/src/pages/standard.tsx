...
export default function StandardWorkspace() {
  ...
  return (
    <div className="flex flex-col gap-5 animate-in fade-in duration-500">
      ...
      <div className="ccc-page-heading"><div><p className="ccc-eyebrow">SEPARATE WORKSPACE</p><h1>Standard PAPER</h1><p>수동 거래 및 기존 계정입니다. Virtual 400의 잔액·손익과 합산되지 않습니다.</p></div><Link href="/" className="ccc-text-link">Virtual 400으로 돌아가기 →</Link></div>
